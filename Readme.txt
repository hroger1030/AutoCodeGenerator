A quick note from me to you...
   ...
   I spent a number of years writing and using this code, it seems a waste to not share it with anyone who might benefit from it. I am sharing this under the MIT license, so you can do pretty much anything with it. It would be nice if you wanted to share any 
code additions or bug fixes.
   ...
   To use it, point it at a SQL DB, and then select the objects that you wish to generate and click the button. The files will be spit out in a subdirectory and you can add them to your project. If you make any changes to your SQL schema, regenerate the files and your
code will reflect the changes.
